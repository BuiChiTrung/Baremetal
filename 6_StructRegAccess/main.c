// 0: Include standard integer types header for fixed-width
// integer types
#include <stdint.h>
...
// RCC_BASE is casted to a pointer of type RCC_TypeDef, allowing access to its
// members MODER, OTYPER, etc.
#define RCC ((RCC_TypeDef *)RCC_BASE)
// Similarly for GPIOA_BASE and GPIOA.
