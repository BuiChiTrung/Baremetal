...
//   // Set the multi-byte read enable bit to read multiple consecutive
//   registers address |= ADXL345_MULTI_BYTE_ENABLE;
...
//   // Read 6 bytes of data from the accelerometer (X, Y, Z axes - 2 bytes
//   each) spi1_receive(rxdata, 6);
